...
from pytorch_pretrained_bert.modeling import BertForMaskedLMTeacher,BertForMaskedLMStudent, BertConfig
...
def random_word(tokens, tokenizer):
    ...
    return tokens, output_label, token_types
...
def main():
    ...
    if args.do_train:
        ...
        print("param nums", sum(param.numel() for param in model.parameters()))
