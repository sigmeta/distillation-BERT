...
from pytorch_pretrained_bert.modeling import BertForPolyphony2Classification, BertConfig, WEIGHTS_NAME, CONFIG_NAME
...
def main():
    ...
    model = BertForPolyphony2Classification.from_pretrained(args.bert_model,
              cache_dir=cache_dir,
    ...
    if args.do_train:
        ...
        all_type_ids = torch.tensor([f.type_id for f in train_features], dtype=torch.long)
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                loss = model(input_ids, input_mask, label_ids, label_poss, type_ids)
                if n_gpu > 1:
    ...
    if args.do_train:
        ...
        model = BertForPolyphony2Classification.from_pretrained(args.bert_model, num_labels = num_labels)
    model.to(device)
