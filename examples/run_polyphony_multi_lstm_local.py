...
from pytorch_pretrained_bert.modeling import BertForPolyphonyMultiLSTMLocal, BertConfig, WEIGHTS_NAME, CONFIG_NAME, OPTIMIZER_NAME
    ...
    if args.do_train:
        ...
        for ep in trange(max_epoch+1,int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.eval_every_epoch:
                ...
                config = BertConfig(output_config_file)
                model_eval = BertForPolyphonyMultiLSTMLocal(config, num_labels=num_labels)
