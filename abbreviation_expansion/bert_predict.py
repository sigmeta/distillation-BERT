...
class InputExample(object):
    ...
    def __init__(self, unique_id, text_a, text_b,labels, candidates):
...
class InputFeatures(object):
    ...
    def __init__(self, unique_id, target_ids, input_ids, input_mask, input_type_ids, candidates):
        self.unique_id = unique_id
...
def main():
    ...
    model = BertForScore.from_pretrained(args.bert_model)
    model.to(device)
    ...
    all_candidates = [f.candidates for f in features]
            ...
            for b, example_index in enumerate(example_indices):
                ...
                if unique_id==0:
                    ...
                    for candidate in all_candidates[unique_id]:
                        ...
                        score = float((scores[b,can_ids]).mean())
